...
public class SoundHandler : MonoBehaviour
{
    ...
    [SerializeField] private List<AudioClip> balloonClips = new();

    [SerializeField] private AudioClip failClip;
    [SerializeField] private AudioClip winClip;
    [SerializeField] private AudioClip completePuzzleClip;
    [SerializeField] private AudioClip startClip;
    [SerializeField] private AudioClip clapsClip;
    [SerializeField] private AudioClip EnglishNameClip;
    [SerializeField] private AudioClip RussianNameClip;

    [SerializeField] private float startClipTime = 0.5f;
